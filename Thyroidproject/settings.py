"""
Django settings for Thyroidproject project.
...
SECRET_KEY = 'django-insecure-p(-+f7dou$v#2tio-h4whvj%1#=v)*gs%l$9-4c-!pw*b$2ik!'
...
ROOT_URLCONF = 'Thyroidproject.urls'
...
WSGI_APPLICATION = 'Thyroidproject.wsgi.application'
